...
class WifiMainActivity : AppCompatActivity() {
    ...
    private fun sendRegister(username: String, password: String, email: String) {
        ...
        val request = Request.Builder()
            .url("http://192.168.43.240/Register.php") // ganti IP sesuai XAMPP/laptop kamu
            .post(formBody)
            .build()
        ...
        httpClient.newCall(request).enqueue(object : Callback {
            override fun onFailure(call: Call, e: IOException) {
                runOnUiThread {
                    Toast.makeText(this@WifiMainActivity, "Gagal kirim ke server!", Toast.LENGTH_SHORT).show()
                }
            }
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                runOnUiThread {
                    Toast.makeText(this@WifiMainActivity, "Respon server: $resp", Toast.LENGTH_LONG).show()
                }
            }
        })
    }
